 ...
 * for better reusability and maintenance.
 */
...
export const SVGIcons = {
    ...
    // Welcome message sparkles and document icon
    ...
    // Avatar icons for different agent types
    ...
    // Avatar icon options for user icon selection
 ...
 * @param {string} iconName - Name of the icon from SVGIcons
 * @param {string} fill - Fill color (default: 'white')
 * @returns {string} Data URI string
 */
export function getSVGDataUri(iconName, fill = 'white') {
    const iconSVG = SVGIcons[iconName];
    if (!iconSVG) {
        console.warn(`SVG icon '${iconName}' not found`);
        return '';
    ...
    const svgWithFill = iconSVG.replace(/fill=['"]currentColor['"]|fill=['"]white['"]/, `fill='${fill}'`);
...
export function getSVGPath(iconName) {
    ...
    // For simple path-only icons like arrows
