...
1. DirectLine 当前架构基线为 `DirectLineService` 单实现。
2. 迭代进度唯一来源为 `docs/iterations/TODO.md`。
3. Batch 3 已完成，并包含初始化稳定性修复。
4. Batch 8-12 规划文档已补齐（requirements + design + checklist + test-plan）。
...
- **可折叠侧边栏**，移动端支持滑动手势
- **移动端AI伴侣访问**，通过浮动操作按钮
- **Appearance 可见性控制**，可按需隐藏用户消息和指标信息
