# DirectLine 三组件架构设计文档

> 📚 **文档导航**: [文档索引](../../../../ARCHITECTURE_DOCUMENTATION_INDEX.md) | [连接器设计](./DIRECTLINE_CONNECTOR_DESIGN_DOCUMENT.md) | [时序图对比](../../../../src/components/directline/docs/DIRECTLINE_SEQUENCE_DIAGRAM_COMPARISON.md) | [测试页面](../../../../tests/directline/test-directline-refactored-architecture.html)
...
graph TB
    subgraph "MCSChat Application"
        ...
        subgraph "Component Layer"
            ...
            MQM[MessageQueueManager<br/>• 消息处理<br/>• 消息计数<br/>• 历史记录<br/>• 消息过滤]
            WCR[WebChatRenderer<br/>• UI渲染<br/>• 样式管理<br/>• 容器管理<br/>• 事件处理]
        end
